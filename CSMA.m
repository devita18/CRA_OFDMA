...
N = 300; % get number of nodes *
% Packet_size = Input(2) * 8; % get the packet size in bits % Level bit
Packet_size = 150; %Banyak Paket
T = 10; %Timeslot %
Backoff_St = 2; % get the random backoff strategy %
